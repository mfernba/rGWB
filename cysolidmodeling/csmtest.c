...
void csmtest_test(void)
{
    ...
    */
    ...
    //i_test_cilindro1(viewer); // <-- Revisar diferencia y unión,
                              // revisar clasificación de on-edges en vtxfacc, ver cómo usar la ecuación del
                              // plano.
