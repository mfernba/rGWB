...
DLL_RGWB CONSTRUCTOR(struct csmsolid_t *, csmshape3d_create_torus, (
...
DLL_RGWB CONSTRUCTOR(struct csmsolid_t *, csmshape3d_create_cone, (
...
DLL_RGWB CONSTRUCTOR(struct csmsolid_t *, csmshape3d_create_sphere, (
                        double radius,
