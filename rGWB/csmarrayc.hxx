...
typedef CSMBOOL (*csmarrayc_FPtr_match_condition)(const char *element, const csmarrayc_byte *data);
...
typedef enum csmcompare_t (*csmarrayc_FPtr_compare_1_extra)(const char *element1, const char *element2, const struct csmarrayc_extra_item_t *extra_item);
