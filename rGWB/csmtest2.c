...
static void i_test_union_solidos1(void)
{
    struct csmshape2d_t *shape2d;
...
static void i_test_union_solidos2(void)
{
    struct csmshape2d_t *shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_union_solidos4(void)
{
...
static void i_test_union_solidos5(void)
{
...
static void i_test_interseccion_solidos1(void)
{
    struct csmshape2d_t *shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_interseccion_solidos2(void)
{
...
static void i_test_interseccion_solidos5(void)
{
    struct csmshape2d_t *shape2d, *circular_shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_interseccion_solidos7(void)
{
...
static void i_test_union_solidos6(void)
{
    struct csmshape2d_t *shape2d, *circular_shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_union_solidos7(void)
{
    struct csmshape2d_t *shape2d, *circular_shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
    struct csmshape2d_t *shape3d;
...
static void i_test_union_solidos8(void)
{
    struct csmshape2d_t *shape2d1, *shape2d2;
    struct csmsolid_t *solid1, *solid2, *solid_res;
    ...
    csmdebug_set_viewer_parameters(solid1, solid2);
    csmdebug_show_viewer();
...
static void i_test_interseccion_solidos3(void)
{
    struct csmshape2d_t *shape2d, *circular_shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_interseccion_solidos4(void)
{
    struct csmshape2d_t *shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_resta_solidos1(void)
{
    struct csmshape2d_t *shape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_resta_solidos2(void)
{
...
static void i_test_multiple_solidos1(void)
{
...
static void i_test_multiple_solidos2(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_multiple_solidos3(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro1(void)
{
...
static void i_test_cilindro2(void)
{
    struct csmshape2d_t *shape2d, *cshape2d, *shape2d2;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro5(void)
{
    struct csmshape2d_t *shape2d, *cshape2d, *shape2d2;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro5_redux(void)
{
    struct csmshape2d_t *shape2d, *cshape2d, *shape2d2;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro6(void)
{
    struct csmshape2d_t *shape2d, *cshape2d, *shape2d2;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro7(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro7_redux(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
    ...
    /*
        ...
        */
    ...
    
        {
            ...
            csmdebug_set_viewer_results(csmarrayc_get_st(shells, 0, csmsolid_t), NULL);
            csmsolid_print_debug(csmarrayc_get_st(shells, 0, csmsolid_t), CSMTRUE);
            csmdebug_show_viewer();

            csmdebug_set_viewer_results(csmarrayc_get_st(shells, 1, csmsolid_t), NULL);
...
static void i_test_cilindro7_redux2(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro3(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro4(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    ...
    
    {
        ...
        
        {
            ...
            i_set_output_debug_file("inters_cilindro2_last_step.she");
            {
                ...
                //csmdebug_set_viewer_parameters(void, solid_above, NULL);
                //csmdebug_show_viewer();
                //csmdebug_set_viewer_results(NULL, NULL);
...
static void i_test_cilindro8(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_cilindro9(void)
{
    struct csmshape2d_t *shape2d, *cshape2d;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_difference1(void)
{
    struct csmshape2d_t *shape2d, *shape2d2;
    double lenght;
    struct csmsolid_t *solid1, *solid2, *solid_res;
...
static void i_test_difference10(void)
{
    struct csmsolid_t *solid_res;
...
static void i_test_difference11(void)
{
    struct csmsolid_t *solid_res;
...
static void i_test_facetedbrep1(void)
{
    struct csmfacbrep2solid_t *builder;
    csmArrPoint3D *loop_points;
...
static void i_test_facetedbrep2(CSMBOOL test_error)
{
    struct csmfacbrep2solid_t *builder;
    ...
    else
    {
        ...
        /*
        csmdebug_set_viewer_results(NULL, NULL);
        csmdebug_set_viewer_parameters(void, solid, NULL);
        csmdebug_show_viewer();
...
static void i_test_performance_1(void)
{
    struct csmshape2d_t *shape2d;
    struct csmsolid_t *solid1;
    double l1, e1, l2, h1;
    ...
    
    {
        ...
        points = csmArrPoint2D_new(0);
        csmArrPoint2D_append_circle_points(points, 0., 0., 0.5 * hole_diameter, 16, CSMFALSE);
        ...
        for (unsigned long i = 0; i < no_rows; i++)
        {
            ...
            for (unsigned long j = 0; j < no_columns; j++)
            {
                ...
                hole_solid = csmsweep_create_solid_from_shape(
                        hole_shape, column_coord, -0.01, row_coord, 1., 0., 0., 0., 0., 1.,
                        hole_shape, column_coord,  0.01, row_coord, 1., 0., 0., 0., 0., 1.);
    ...
    csmdebug_set_viewer_results(solid1, NULL);
    csmdebug_show_viewer();
...
static void i_test_performance_2(void)
{
    struct csmshape2d_t *shape2d;
    struct csmsolid_t *solid1;
    ...
    
    {
        ...
        hole_solid = csmsweep_create_solid_from_shape(
                        ...
                        hole_shape, 0.,  0.05, 0., 1., 0., 0., 0., 0., 1.);
...
void csmtest2_test(CSMBOOL process_all_test)
{
    /*csmdebug_configure(CSMTRUE, CSMTRUE, CSMTRUE);
    ...
    */
    ...
    //i_test_performance_2();
    //i_test_performance_1();
    
    //return;
    
    csmdebug_set_treat_improper_solid_operations_as_errors(CSMTRUE);
    csmdebug_configure(CSMTRUE, CSMTRUE, CSMTRUE);
    //i_test_union_solidos8();
    //i_test_interseccion_solidos7();

    csmdebug_set_treat_improper_solid_operations_as_errors(CSMTRUE);
    csmdebug_configure(CSMFALSE, CSMTRUE, CSMFALSE);
    //i_test_cilindro7_redux();
    //i_test_cilindro9();
    ...
    //i_test_mechanical5();
    //return;
    //i_test_facetedbrep2(void, CSMFALSE);
    //i_test_difference10();
    //return;
    ...
    else
    {
        ...
        i_test_union_solidos1();
        i_test_union_solidos2();
        i_test_union_solidos4();
        i_test_union_solidos5();
        i_test_union_solidos6();
        i_test_union_solidos7();
        i_test_union_solidos8();
        
        i_test_interseccion_solidos1();
        i_test_interseccion_solidos2();
        i_test_interseccion_solidos3();
        i_test_interseccion_solidos4();
        i_test_interseccion_solidos5();
        i_test_interseccion_solidos7();
        i_test_resta_solidos1();
        i_test_resta_solidos2();
        i_test_multiple_solidos1();
        i_test_multiple_solidos2();
        i_test_multiple_solidos3();
        i_test_cilindro1();
        i_test_cilindro2();
        i_test_cilindro3();
        
        i_test_cilindro5_redux();
        i_test_difference8();
        i_test_difference8_redux();
        i_test_difference9();
        i_test_difference10();
        ...
        csmdebug_set_treat_improper_solid_operations_as_errors(CSMFALSE);
        {
            i_test_cilindro4(); // --> Revisar la orientación de las caras del hueco, falla split a 0,75. Assert de puntos repetidos al realizar la diferencia, arista nula no borrada?
            i_test_cilindro5(); // -- Intersecciones non-manifold.
            i_test_cilindro6(); // --> Intersecciones non-manifold.
            //i_test_cilindro7(); // --> Intersecciones non-manifold.
            i_test_cilindro8(); // --> Intersecciones non-manifold.
        }
        csmdebug_set_treat_improper_solid_operations_as_errors(CSMTRUE);
        
        //i_test_cilindro7_redux(); // --> Intersecciones non-manifold.
        
        i_test_cilindro9(); // --> Intersecciones non-manifold.
        ...
        i_test_facetedbrep1();
        i_test_facetedbrep2(CSMTRUE);
        
        csmdebug_set_treat_improper_solid_operations_as_errors(CSMFALSE);
        i_test_facetedbrep2(CSMFALSE);
    }
}
