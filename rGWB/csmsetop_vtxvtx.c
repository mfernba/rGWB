                        ...
                        CSMBOOL U2_is_real_hedge))
{
    ...
    neighborhood->U1_is_real_hedge = U1_is_real_hedge;
    neighborhood->U2_is_real_hedge = U2_is_real_hedge;
...
static void i_vector_to_he(struct csmhedge_t *he, const struct csmvertex_t *vertex, double *Ux, double *Uy, double *Uz)
{
    ...
    csmvertex_vector_from_vertex1_to_vertex2(vertex, he_vertex, Ux, Uy, Uz);
}
                        ...
                        const struct csmtolerance_t *tolerances))
{
    ...
    do
    {
        ...
        CSMBOOL U1_is_real_hedge, U2_is_real_hedge;
        ...
        U1_is_real_hedge = CSMTRUE;
        U2_is_real_hedge = CSMTRUE;
        
        neigborhood = i_create_neighborhood(
                        he_iterator,
                        Ux1, Uy1, Uz1,
                        Ux2, Uy2, Uz2,
                        Ux12, Uy12, Uz12,
                        he_iterator_face, A, B, C, D, face_tolerance,
                        U1_is_real_hedge, U2_is_real_hedge);
        ...
        if (is_null_vector == CSMTRUE || is_oriented_in_direction == CSMTRUE)
        {
            ...
            U1_is_real_hedge = CSMFALSE;
            U2_is_real_hedge = CSMTRUE;
            
            neigborhood_bisec = i_create_neighborhood(
                        he_iterator,
                        Ux_bisec, Uy_bisec, Uz_bisec,
                        Ux2, Uy2, Uz2,
                        Ux12_bisec, Uy12_bisec, Uz12_bisec,
                        he_iterator_face, A, B, C, D, face_tolerance,
                        U1_is_real_hedge, U2_is_real_hedge);
            ...
            neigborhood->U2_is_real_hedge = CSMFALSE;
...
static CSMBOOL i_is_intersection_parallel_to_sector_edge(
                        ...
                        const struct csmtolerance_t *tolerances,
                        CSMBOOL test_parallelism_using_distances,
                        CSMBOOL *same_sense)
{
    ...
    {
        if (test_parallelism_using_distances == CSMTRUE)
        {
            double distance;
            double tolerance;
                        ...
                        CSMBOOL test_parallelism_using_distances)
{
    ...
    if (i_is_intersection_parallel_to_sector_edge(
                        ...
                        neighborhood->Ux1_u, neighborhood->Uy1_u, neighborhood->Uz1_u,
                        tolerances,
                        test_parallelism_using_distances,
                        &same_sense) == CSMTRUE)
    {
        return same_sense;
    }
                        ...
                        const struct csmtolerance_t *tolerances)
{
    ...
    else
    {
        ...
        is_within_b = i_is_intersection_within_sector(neighborhood_b, Wx_inters, Wy_inters, Wz_inters, tolerances, test_parallelism_using_distances);
...
static CSMBOOL i_edge_faces_are_convex_between_them(struct csmhedge_t *he, const struct csmtolerance_t *tolerances)
{
...
static CSMBOOL i_is_wide_sector(struct csmhedge_t *he, const struct csmtolerance_t *tolerances)
{
    ...
    else
    {
        ...
        else
        {
            ...
            csmmath_cross_product3D(Ux1, Uy1, Uz1, Ux2, Uy2, Uz2, &Ux12, &Uy12, &Uz12);
            csmmath_make_unit_vector3D(&Ux12, &Uy12, &Uz12);
                        ...
                        const struct csmtolerance_t *tolerances)
{
    ...
    if (mhe1 != he2 && mhe2 == he1)
        orient = i_edge_faces_are_convex_between_them(he2, tolerances);
    else
        orient = i_edge_faces_are_convex_between_them(he1, tolerances);
